...
export function ThemeToggle(){
 ...
 return <button type="button" className="btn theme-toggle" aria-label={'Switch to '+(theme==='dark'?'light':'dark')+' theme'} onClick={toggle}>{theme==='dark'?<Sun size={18}/>:<Moon size={18}/>}<span>{theme==='dark'?'Light':'Dark'} theme</span></button>
}

export type Product={id:string;name:string;barcode:string;category:string;subcategory?:string;price:number;cost:number;stock:number;min:number;unit:string;target?:number;discountMode?:"auto"|"custom"|"none";customDiscount?:number;discountBasis?:"cost"|"price";mrp?:number};
